...
//    Array(1006000, 10000, "遗忘山谷#r              （消耗1万金币）#b"),
    ...
    Array(105200110, 10000, "鲁塔比斯半半房间（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200120, 10000, "鲁塔比斯半半内在世界#r（消耗1万金币）#b"),
    Array(105200210, 10000, "鲁塔比斯皮埃尔房间（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200310, 10000, "鲁塔比斯血腥女王房间（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200410, 10000, "鲁塔比斯贝伦房间（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200510, 10000, "鲁塔比斯半半入口（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200520, 10000, "鲁塔比斯半半内在世界<进阶>#r（消耗1万金币）#b"),
    Array(105200610, 10000, "鲁塔比斯皮埃尔入口（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200710, 10000, "鲁塔比斯血腥女王入口（Boss暂未开放）#r（消耗1万金币）#b"),
    Array(105200810, 10000, "鲁塔比斯贝伦入口（Boss暂未开放）#r（消耗1万金币）#b"),
