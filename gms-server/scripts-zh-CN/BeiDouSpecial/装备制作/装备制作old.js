...
var 鞋子 = [
    ...
    },
    {
        ...
        needItems: [
            ...
            {id: 1072344, qty: 1, tip: "(继承该装备洗练和星级)"},
...
//     sendRandomSceneMegaphone(cm.getPlayer(), tipType, "装备制作", `恭喜玩家${cm.getPlayer().getName()}成功制作出【${cm.getPlayer().getItemName(targetItem.id)}】!`);
//     cm.dispose();
// }
//
// function 获取金币(meso) {
