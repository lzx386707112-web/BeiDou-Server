...
var fhair_e = Array(31140, 31160, 31180, 31210, 31300, 31420, 31460, 31470, 31660, 31690, 31800, 31890, 31910, 31940);
var hairnew = Array();
    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                cm.sendYesNo("如果你使用EXP会员卡，你的发型将会随机改变，并有机会获得我设计的新实验性发型。你要使用 #b#t5150024##k 真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通会员卡，你的发型将会随机改变。你还想使用 #b#t5151019##k 来改变吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
