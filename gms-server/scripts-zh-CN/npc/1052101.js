...
var mhair_r = Array(30040, 30130, 30520, 30770, 30770, 30850, 30920, 33030);
var fhair_r = Array(31060, 31140, 31330, 31440, 31520, 31750, 31760, 31880, 34040);
var mhair_e = Array(30130, 30420, 30520, 30770, 30770, 30850, 30920, 33030);
var fhair_e = Array(31060, 31140, 31330, 31520, 31760, 31880, 34010, 34040);
var hairnew = Array();
    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendYesNo("如果您使用普通会员卡，您的发型将随机改变，并有机会获得我设计的新实验风格。您要使用#b#t5150011##k来真正改变您的发型吗？");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用了EXP会员卡，你的发型将会随机改变，并有机会获得我设计的新实验性发型。你要使用 #b#t5150011##k 真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通会员卡，你的发型将会随机改变。你还想使用 #b#t5151002##k 来改变吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
