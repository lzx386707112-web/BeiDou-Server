...
var mhair_v = Array(30040, 30130, 30770, 30850, 30860, 30920, 33030);
var fhair_v = Array(31090, 31140, 31330, 31440, 31760, 31880, 34040);
var hairnew = Array();
...
function action(mode, type, selection) {
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
    {
        ...
        if (status == 0) {
            cm.sendSimple("你好！我是美容院的院长#b#p1052100##k！如果你有#b#t5150003##k或者#b#t5151003##k，为什么不让我来照顾剩下的事情呢？决定你想要怎么处理你的头发...\r\n#L1#理发：#i5150003##t5150003##l\r\n#L2#染发：#i5151003##t5151003##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
