...
var mhair_e = Array(30250, 30400, 30420, 30440, 30490, 30730, 30830, 30870, 30880, 33100);
    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                cm.sendYesNo("如果你使用了EXP会员卡，你的发型将会随机改变，并有机会获得我设计的新实验性发型。你要使用 #b#t5150030##k 真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通会员卡，你的发型将会随机改变。你还想使用 #b#t5151025##k 来改变吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
