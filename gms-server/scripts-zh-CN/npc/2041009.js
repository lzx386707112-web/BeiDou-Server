...
var fhair_e = Array(31170, 31270, 31420, 31510, 31540, 31550, 31600, 31680, 31810, 31830, 31840, 31870);
var hairnew = Array();
    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendYesNo("如果您使用普通会员卡，您的发型将随机改变，并有机会获得我设计的新实验风格。您要使用#b#t5150006##k来真正改变您的发型吗？");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用一般会员卡，你的发型将会随机改变，并有机会获得我设计的新实验性发型。你要使用 #b#t5150012##k 真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通会员卡，你的发型将会随机改变。你还想使用 #b#t5151006##k 来改变吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
                ...
                if (cm.haveItem(5150006)) {
                    ...
                    cm.sendOk("嗯...看起来你没有我们指定的会员卡...恐怕我不能在没有它的情况下给你染发。对不起...");
                }
            } else if (beauty == 0) {
