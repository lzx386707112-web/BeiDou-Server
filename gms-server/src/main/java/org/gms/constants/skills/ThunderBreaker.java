...
public class ThunderBreaker {
    ...
    public static final int SEA_DRAGON_SPIRAL_TICK = 15121021;
    public static final int LIGHTNING_SPEAR_COMBO_VISUAL_FIRST = 15121022;
    public static final int LIGHTNING_SPEAR_COMBO_VISUAL_LAST = 15121033;
