...
public final class MobDamageMobFriendlyHandler extends AbstractPacketHandler {
    ...
    public final void handlePacket(InPacket p, Client c) {
        ...
        int damageBound = (int) Math.min(Integer.MAX_VALUE, ((monster.getMaxHp() / 13 + monster.getPADamage() * 10L)) * 2 + 500);
        int damage = Randomizer.nextInt(damageBound) / 10; // Formula planned by Beng.
