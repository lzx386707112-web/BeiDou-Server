...
public class BotHelpers {
    ...
    public static org.gms.client.Character getCharFromChannelStorage(int cid) {
        ...
        org.gms.client.Character fakechar = channel.getPlayerStorage().getCharacterById(cid);
        if (isBot(fakechar)) {
            return (fakechar);
        }
        return null;
