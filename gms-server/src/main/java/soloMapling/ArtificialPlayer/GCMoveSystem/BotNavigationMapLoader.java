...
/* loaded from: asm-bot-mini.jar:org/gms/soloMapling/ArtificialPlayer/GCMoveSystem/BotNavigationMapLoader.class */
final class BotNavigationMapLoader {
    ...
    private static void loadBounds(MapleMap map, Data mapData, Data infoData) {
        ...
        if (top == bottom) {
            ...
            map.setMapPointBoundings((-262144) / 2, (-262144) / 2, 262144, 262144);
            return;
        }
    ...
    private static String getMapName(int mapId) {
        return "Map/Map" + (mapId / 100000000) + "/" + String.format("%09d", Integer.valueOf(mapId)) + ".img";
    }
}
