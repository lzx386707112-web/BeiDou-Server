...
extern "C" __attribute__((naked, noinline)) void HookHighSkillVisualBranch() {
    __asm__ __volatile__(
        ...
        "cmp esi, 1321011\n"
        "jb explorer_dark_knight_visual_next\n"
        "cmp esi, 1321026\n"
        "jbe 5f\n"
        "explorer_dark_knight_visual_next:\n"
        "cmp esi, 15121000\n"
...
extern "C" __attribute__((naked, noinline)) void HookBrandishActionType() {
    __asm__ __volatile__(
        ...
        "cmp eax, 1221015\n"
        "jb explorer_paladin_action_next\n"
        "cmp eax, 1221032\n"
        "jbe 2f\n"
        "explorer_paladin_action_next:\n"
        "cmp eax, 1321011\n"
        "jb explorer_dark_knight_action_next\n"
        "cmp eax, 1321026\n"
        "jbe 2f\n"
        "explorer_dark_knight_action_next:\n"
        "cmp eax, 11121005\n"
        "jb 1f\n"
        "cmp eax, 11121012\n"
        "ja 1f\n"
...
extern "C" __attribute__((naked, noinline)) void HookBrandishVisualOffset() {
    __asm__ __volatile__(
        ...
        "cmp eax, 1221015\n"
        "jb explorer_paladin_offset_next\n"
        "cmp eax, 1221032\n"
        "jbe 2f\n"
        "explorer_paladin_offset_next:\n"
        "cmp eax, 1321011\n"
        "jb explorer_dark_knight_offset_next\n"
        "cmp eax, 1321026\n"
        "jbe 2f\n"
        "explorer_dark_knight_offset_next:\n"
        "cmp eax, 11121005\n"
        "jb 1f\n"
        "cmp eax, 11121012\n"
        "ja 1f\n"
...
extern "C" __attribute__((naked, noinline)) void HookBrandishStateSwitch() {
    __asm__ __volatile__(
        ...
        "cmp esi, 1221015\n"
        "jb explorer_paladin_state_next\n"
        "cmp esi, 1221032\n"
        "jbe 3f\n"
        "explorer_paladin_state_next:\n"
        "cmp esi, 1321011\n"
        "jb explorer_dark_knight_state_next\n"
        "cmp esi, 1321026\n"
        "jbe 3f\n"
        "explorer_dark_knight_state_next:\n"
        "cmp esi, 11121005\n"
        "jb 1f\n"
        "cmp esi, 11121012\n"
        "ja 1f\n"
...
extern "C" __attribute__((naked, noinline)) void HookBrandishHit() {
    __asm__ __volatile__(
        ...
        "cmp ebx, 1221015\n"
        "jb explorer_paladin_hit_next\n"
        "cmp ebx, 1221032\n"
        "jbe 2f\n"
        "explorer_paladin_hit_next:\n"
        "cmp ebx, 1321011\n"
        "jb explorer_dark_knight_hit_next\n"
        "cmp ebx, 1321026\n"
        "jbe 2f\n"
        "explorer_dark_knight_hit_next:\n"
        "cmp ebx, 11121005\n"
        "jb 1f\n"
        "cmp ebx, 11121012\n"
        "ja 1f\n"
