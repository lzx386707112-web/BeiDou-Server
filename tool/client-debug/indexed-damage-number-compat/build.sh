...
source_file="$root_dir/tool/client-debug/indexed-damage-number-compat/IndexedDamageNumberCompat.cpp"
output_file="$root_dir/clien/IndexedDamageNumberCompat.dll"
