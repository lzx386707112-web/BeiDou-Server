...
_BOSS_INFO = {
    ...
    "speed": "移动速度。",
    "fs": "攻击速度。",
    "PADamage": "物理攻击力。LifeFactory 无默认值，复制 info 时必须存在。",
    "PDDamage": "物理防御。TMS 常只有 PDRate；缺此项召唤 NPE。",
    "MADamage": "魔法攻击力。LifeFactory 无默认值。",
    "MDDamage": "魔法防御。TMS 常只有 MDRate；缺此项召唤 NPE。",
    "PDRate": "物理减伤率。不能代替 PDDamage。",
    "MDRate": "魔法减伤率。不能代替 MDDamage。",
    "hp": "当前血量。",
