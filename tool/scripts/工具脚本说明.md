...
```sh
PACK_IMG_WZ_JAVA_OPTS="-Xms512m -Xmx12g -XX:+UseG1GC" rtk tool/scripts/pack_img_wz.sh --input clien/Data/Character --output "$HOME/Downloads/Character.wz" --version 83
```
